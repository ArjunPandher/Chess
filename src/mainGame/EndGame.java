/*
 * End Game Chess
 * Like normal Chess but without any of the good pieces!
 * Both sides only have their Kings, and a row of pawns.
 * As the name suggests, for those that enjoy the end-game of Chess.
 */
...
public class EndGame implements ActionListener {
	...
	public String gameType = "EndGame";
	...
	public EndGame ()
	{
		...
		// setting the board up with the setup for End Game Chess
	...
	private void kingMovePiece ()
	{
		...
		// CASTLING NOT POSSIBLE AS NEITHER SIDE STARTS OFF WITH ANY ROOKS
	}
	// if the piece moves like a rook

/*
 * Horde Chess
 * A variant of Dunsay's Chess with two pawns places a little forward.
 */
...
public class Horde implements ActionListener {
	...
	public Horde ()
	{
		...
		// setting the board up with the setup for Horde Chess
		
		boardPieces[0] [0] = new ChessPiece ('b', "pawn");
		boardTiles [0] [0].setIcon(bPawn);

		boardPieces[0] [1] = new ChessPiece ('b', "pawn");
		boardTiles [0] [1].setIcon(bPawn);

		boardPieces[0] [2] = new ChessPiece ('b', "pawn");
		boardTiles [0] [2].setIcon(bPawn);

		boardPieces[0] [4] = new ChessPiece ('b', "king");
		boardTiles [0] [4].setIcon(bKing);

		boardPieces[0] [5] = new ChessPiece ('b', "pawn");
		boardTiles [0] [5].setIcon(bPawn);

		boardPieces[0] [6] = new ChessPiece ('b', "pawn");
		boardTiles [0] [6].setIcon(bPawn);

		boardPieces[0] [7] = new ChessPiece ('b', "pawn");
		boardTiles [0] [7].setIcon(bPawn);

		boardPieces[4] [3] = new ChessPiece ('b', "pawn");
		boardTiles [4] [3].setIcon(bPawn);

		boardPieces[4] [4] = new ChessPiece ('b', "pawn");
		boardTiles [4] [4].setIcon(bPawn);
		...
		for (int x = 0; x < boardPieces.length; x++)
		{
			...
			boardPieces[3] [x] = new ChessPiece ('b', "pawn");
			boardTiles [3] [x].setIcon(bPawn);
	...
	private void kingMovePiece ()
	{
		...
		// CASTLING IN THIS GAMEMODE ONLY EXISTS FOR THE WHITE PLAYER

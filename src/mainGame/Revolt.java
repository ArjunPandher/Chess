/*
 * Peasant's Revolt
 * Black has four Knights, a King and a single Pawn (the nobles).
 * White has a row of Pawns and a King (the peasants).
...
public class Revolt implements ActionListener {
	...
	public Revolt ()
	{
		...
		// setting the board up with the setup for peasant's revolt
		...
		boardPieces[1] [4] = new ChessPiece ('b', "pawn");
		boardTiles [1] [4].setIcon(bPawn);
	...
	private void kingMovePiece ()
	{
		...
		// CASTLING NOT POSSIBLE AS NEITHER SIDE STARTS OFF WITH A ROOK
	}
	// if the piece moves like a rook

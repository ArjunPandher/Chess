/* 
 * Classic Chess
 * Ah, the timeless game of chess.
 * Nothing new here, just your normal version of chess.
 */
...
public class Chess implements ActionListener {
	...
	public static Icon bQueen = new ImageIcon("src/pieces/bQueen" + Options.pieceType + ".png");
	public static Icon bKing = new ImageIcon("src/pieces/bKing" + Options.pieceType + ".png");
	public static Icon bRook = new ImageIcon("src/pieces/bRook" + Options.pieceType + ".png");	
	public static Icon bBishop = new ImageIcon("src/pieces/bBishop" + Options.pieceType + ".png");
	public static Icon bKnight = new ImageIcon("src/pieces/bKnight" + Options.pieceType + ".png");
	public static Icon bPawn = new ImageIcon("src/pieces/bPawn" + Options.pieceType + ".png");

	public static Icon wQueen = new ImageIcon("src/pieces/wQueen" + Options.pieceType + ".png");
	public static Icon wKing = new ImageIcon("src/pieces/wKing" + Options.pieceType + ".png");
	public static Icon wRook = new ImageIcon("src/pieces/wRook" + Options.pieceType + ".png");	
	public static Icon wBishop = new ImageIcon("src/pieces/wBishop" + Options.pieceType + ".png");
	public static Icon wKnight = new ImageIcon("src/pieces/wKnight" + Options.pieceType + ".png");
	public static Icon wPawn = new ImageIcon("src/pieces/wPawn" + Options.pieceType + ".png");
	...
	public static boolean wasRanked = true;		// if true, the game is a ranked game of chess
	...
	public Chess ()
	{
		...
		// setting the board up with the classic setting for chess pieces
		
		boardPieces[0] [0] = new ChessPiece ('b', "rook");
		boardTiles [0] [0].setIcon(bRook);

		boardPieces[0] [1] = new ChessPiece ('b', "knight");
		boardTiles [0] [1].setIcon(bKnight);

		boardPieces[0] [2] = new ChessPiece ('b', "bishop");
		boardTiles [0] [2].setIcon(bBishop);

		boardPieces[0] [3] = new ChessPiece ('b', "queen");
		boardTiles [0] [3].setIcon(bQueen);

		boardPieces[0] [4] = new ChessPiece ('b', "king");
		boardTiles [0] [4].setIcon(bKing);

		boardPieces[0] [5] = new ChessPiece ('b', "bishop");
		boardTiles [0] [5].setIcon(bBishop);

		boardPieces[0] [6] = new ChessPiece ('b', "knight");
		boardTiles [0] [6].setIcon(bKnight);

		boardPieces[0] [7] = new ChessPiece ('b', "rook");
		boardTiles [0] [7].setIcon(bRook);


		for (int x = 0; x < boardPieces.length; x++)
		{
			boardPieces[1] [x] = new ChessPiece ('b', "pawn");
			boardTiles [1] [x].setIcon(bPawn);

			boardPieces[6] [x] = new ChessPiece ('w', "pawn");
			boardTiles [6] [x].setIcon(wPawn);
		}


		boardPieces[7] [0] = new ChessPiece ('w', "rook");
		boardTiles [7] [0].setIcon(wRook);

		boardPieces[7] [1] = new ChessPiece ('w', "knight");
		boardTiles [7] [1].setIcon(wKnight);

		boardPieces[7] [2] = new ChessPiece ('w', "bishop");
		boardTiles [7] [2].setIcon(wBishop);

		boardPieces[7] [3] = new ChessPiece ('w', "queen");
		boardTiles [7] [3].setIcon(wQueen);

		boardPieces[7] [4] = new ChessPiece ('w', "king");
		boardTiles [7] [4].setIcon(wKing);

		boardPieces[7] [5] = new ChessPiece ('w', "bishop");
		boardTiles [7] [5].setIcon(wBishop);

		boardPieces[7] [6] = new ChessPiece ('w', "knight");
		boardTiles [7] [6].setIcon(wKnight);

		boardPieces[7] [7] = new ChessPiece ('w', "rook");
		boardTiles [7] [7].setIcon(wRook);
	...
	private void promoteCheck ()
	{
		if (boardPieces [yIntMove] [xIntMove] != null && boardPieces [yIntMove] [xIntMove].type.equals("pawn"))
		{
			if ( (boardPieces [yIntMove] [xIntMove].owner == 'w' && yIntMove == 0) || (boardPieces [yIntMove] [xIntMove].owner == 'b' && yIntMove == 7))
			{
				...
				if (s.equals("Queen"))
				{
					boardPieces [yIntMove] [xIntMove] = new ChessPiece (playerTurn, "queen");
				...
				{
					boardPieces [yIntMove] [xIntMove] = new ChessPiece (playerTurn, "knight");
					if (boardPieces [yIntMove] [xIntMove].owner == 'w')
					{
				...
				{
					boardPieces [yIntMove] [xIntMove] = new ChessPiece (playerTurn, "rook");
					if (boardPieces [yIntMove] [xIntMove].owner == 'w')
					{
				...
				{
					boardPieces [yIntMove] [xIntMove] = new ChessPiece (playerTurn, "bishop");
					if (boardPieces [yIntMove] [xIntMove].owner == 'w')
					{

 ...
 * White has three Queens, a row of Pawns and a King
 * Black has seven Knights, a row of Pawns and a King
...
public class LightBrigade implements ActionListener {
	...
	public String gameType = "LightBrigade";
	...
	public LightBrigade ()
	{
		...
		// setting the board up with the setup for Charge of the Light Brigade Chess
		...
		boardPieces[7] [1] = new ChessPiece ('w', "queen");
		boardTiles [7] [1].setIcon(wQueen);
		...
		boardPieces[7] [6] = new ChessPiece ('w', "queen");
		boardTiles [7] [6].setIcon(wQueen);
	...
	private void kingMovePiece ()
	{
		...
		// NO CASTLING BECAUSE OF THE LACK OF ROOKS
	}
	// if the piece moves like a rook

/* 
 * Weak!
 * A version of Chess played in Columbia University in the 1960s.
 * White has a normal Chess set.
 * Black has seven Knights, a King and sixteen Pawns set up in a funky way.
 */
...
public class Weak implements ActionListener {
	...
	public Weak ()
	{
		...
		boardPieces[0] [0] = new ChessPiece ('b', "knight");
		boardTiles [0] [0].setIcon(bKnight);

		boardPieces[0] [1] = new ChessPiece ('b', "knight");
		boardTiles [0] [1].setIcon(bKnight);

		boardPieces[0] [2] = new ChessPiece ('b', "knight");
		boardTiles [0] [2].setIcon(bKnight);

		boardPieces[0] [3] = new ChessPiece ('b', "knight");
		boardTiles [0] [3].setIcon(bKnight);

		boardPieces[0] [4] = new ChessPiece ('b', "king");
		boardTiles [0] [4].setIcon(bKing);

		boardPieces[0] [5] = new ChessPiece ('b', "knight");
		boardTiles [0] [5].setIcon(bKnight);

		boardPieces[0] [6] = new ChessPiece ('b', "knight");
		boardTiles [0] [6].setIcon(bKnight);

		boardPieces[0] [7] = new ChessPiece ('b', "knight");
		boardTiles [0] [7].setIcon(bKnight);
		
		boardPieces[3] [3] = new ChessPiece ('b', "pawn");
		boardTiles [3] [3].setIcon(bPawn);
		
		boardPieces[3] [4] = new ChessPiece ('b', "pawn");
		boardTiles [3] [4].setIcon(bPawn);
		...
		for (int x = 0; x < boardPieces.length; x++)
		{
			...
			if (x != 0 && x != 7)
			{
				boardPieces[2] [x] = new ChessPiece ('b', "pawn");
				boardTiles [2] [x].setIcon(bPawn);
			}
	...
	private void kingMovePiece ()
	{
		...
		// WHITE IS THE ONLY PLAYER THAT CAN CASTLE

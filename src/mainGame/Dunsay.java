/*
 * Dunsay's Chess (or Dunsay's Game)
 * A variant of Chess created by Lord Dunsay in 1942.
 * The black player has a normal set of pieces, and goes first.
 * The white player has 31 Pawns, plus a King.
 * The black player's only real goal here is to survive as long as possible, the odds are pretty stacked.
 * Very similar to Horde Chess.
 */
...
public class Dunsay implements ActionListener {
	...
	public Dunsay ()
	{
		...
		// setting the board up with the setup for Dunsay's Chess
		...
		for (int x = 0; x < boardPieces.length; x++)
		{
			...
			boardPieces[4] [x] = new ChessPiece ('w', "pawn");
			boardTiles [4] [x].setIcon(wPawn);

			boardPieces[5] [x] = new ChessPiece ('w', "pawn");
			boardTiles [5] [x].setIcon(wPawn);
		...
		boardPieces[7] [0] = new ChessPiece ('w', "pawn");
		boardTiles [7] [0].setIcon(wPawn);

		boardPieces[7] [1] = new ChessPiece ('w', "pawn");
		boardTiles [7] [1].setIcon(wPawn);

		boardPieces[7] [2] = new ChessPiece ('w', "pawn");
		boardTiles [7] [2].setIcon(wPawn);

		boardPieces[7] [3] = new ChessPiece ('w', "pawn");
		boardTiles [7] [3].setIcon(wPawn);

		boardPieces[7] [4] = new ChessPiece ('w', "king");
		boardTiles [7] [4].setIcon(wKing);

		boardPieces[7] [5] = new ChessPiece ('w', "pawn");
		boardTiles [7] [5].setIcon(wPawn);

		boardPieces[7] [6] = new ChessPiece ('w', "pawn");
		boardTiles [7] [6].setIcon(wPawn);

		boardPieces[7] [7] = new ChessPiece ('w', "pawn");
		boardTiles [7] [7].setIcon(wPawn);
	...
	private void kingMovePiece ()
	{
		...
		// CASTLING IN THIS GAMEMODE ONLY EXISTS FOR THE BLACK PLAYER
